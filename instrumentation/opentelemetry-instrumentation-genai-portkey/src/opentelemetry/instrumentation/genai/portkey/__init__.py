...
Instrumentation for `Portkey AI <https://github.com/Portkey-AI/portkey-python-sdk>`_.
...
from opentelemetry.instrumentation.genai.portkey.package import (
    _instruments,
)
from opentelemetry.instrumentation.genai.portkey.patch import (
    patch_portkey,
    unpatch_portkey,
)
...
__all__ = ["PortkeyInstrumentor"]


class PortkeyInstrumentor(BaseInstrumentor):
    """An instrumentor for Portkey AI."""

    def instrumentation_dependencies(self) -> Collection[str]:
        return _instruments

    def _instrument(self, **kwargs: Any) -> None:
        """Enable Portkey AI instrumentation.
        ...
        patch_portkey(handler)

    def _uninstrument(self, **kwargs: Any) -> None:
        """Disable Portkey AI instrumentation.
