...
"""Conformance scenario: bedrock retrieve_and_generate_stream."""
...
class RetrieveAndGenerateStreamingScenario(Scenario):
        ...
        *,
        ...
        with instrument(
            ...
            with vcr.use_cassette(
                "test_retrieve_and_generate_stream_conformance.yaml"
            ):
                client = boto3.client(
